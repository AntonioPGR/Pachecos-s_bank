...
export const AccountPage = () => {
  ...
  const [statement_value, setStatementValue] = useState(0);

  return (
    <main className='grid grid-cols-3 grid-rows-2 min-h-screen p-8 gap-4 font-default text-cinza-100'>
      ...
      <ActionCard
        ...
        onChangeValue={setStatementValue}
      />
